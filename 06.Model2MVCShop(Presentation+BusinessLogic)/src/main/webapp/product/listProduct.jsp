	...
	<tr>
		<td align="right">
			<select name="searchCondition" class="ct_input_g" style="width:80px">
				<option id="searchCondition" value="1" ${ ! empty search.searchCondition && search.searchCondition==1 ? "selected" : "" }>상품번호</option>
				<option id="searchCondition" value="2" ${ ! empty search.searchCondition && search.searchCondition==2 ? "selected" : "" }>상품명</option>
			</select>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr>
		...
		<td class="ct_list_b" width="100"><a href="/listProduct.do?menu=${param.menu }&searchValue=0">물품번호순</a></td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150"><a href="/listProduct.do?menu=${param.menu }&searchValue=1">이름 정렬</a></td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150"><a href="/listProduct.do?menu=${param.menu }&searchValue=2">가격낮은순</a></td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150"><a href="/listProduct.do?menu=${param.menu }&searchValue=3">등록일빠른순</a></td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150"><a href="/listProduct.do?menu=${param.menu }&searchValue=4">안팔린물건</a></td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150">
			<details>
				...
				<a href="javascript:fncSearchPrice('1');">검색</a>
			</details></td>	
	</tr>
	<tr>
